  ...
  return (
    <div className="flex flex-col gap-2 bg-slate-800 p-4 md:px-28 justify-center rounded-lg">
      <div className="flex justify-center">
        <BenchIcon fill="orange" className="h-10 w-10" /> <span className="text-white underline">Bench Press</span>
      </div>

      <div className="flex gap-2 justify-center">
        <div className="flex flex-col">
          <input type="text" name="bench-input-set" id="bench-input-set" className="rounded-md w-12" />
          <label htmlFor="bench-input-set" className="text-white">
            Sets
          </label>
        </div>
        ...
        <div className="flex flex-col">
          ...
          <label htmlFor="bench-input-rep" className="text-white">
            Reps
          </label>
        </div>
        ...
        <div className="flex flex-col">
          <input type="text" name="bench-input-weight" id="bench-input-weight" className="rounded-md w-12" />
          <label htmlFor="bench-input-weight" className="text-white">
            lbs
          </label>
        </div>
      </div>
