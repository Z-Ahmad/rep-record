...
const SquatInput = () => {
  return (
    <div className="flex flex-col gap-2 bg-slate-800 p-4 px-5 md:px-28 justify-center rounded-lg">
      <div className="flex justify-center">
        <SquatIcon fill="orange" className="h-10 w-10" /> <span className="text-white underline">Squat</span>
      </div>
      ...
      <div className="flex gap-2 justify-center">
        ...
        <div className="flex flex-col">
          <input type="text" name="squat-input-weight" id="squat-input-weight" className="rounded-md w-12" />
          <label htmlFor="squat-input-weight" className="text-white">
            lbs
          </label>
        </div>
